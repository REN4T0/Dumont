    ...
    <main class="my-5">
        ...
        <div id="formulario" class="border border-3 rounded-3">
            ...
            <form action="proc_edit.php" method="post">
                ...
                <div class="row">
                    <button class="btn text-white m-auto d-block mt-5 text-uppercase fw-bold mb-3" href="proc_edit.php" id="update" type="submit">editar</button>
                    
                    <a href="gerenc_usuario2.php" class="btn btn-danger text-uppercase fw-bold" role="button" aria-pressed="true">voltar</a>
                </div>
            </form>
